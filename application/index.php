...
if(isset($_POST['login'])){
    if($action->loginCustomer($_POST['username'], $_POST['password'])){
    ...
    <div class="rightHalf">
        <div class="position-relative">
            ...
            <div class="login-form">
                ...
                <?php endif; ?>
                <h4 class="text-uppercase- text-purple text-center mb-5">Login to Application</h4>
                <form action="" method="POST">
                    <div class="form-group">
                        <input type="text" required class="form-control" id="exampleInputEmail1" placeholder="Enter Username" name="username">
                    </div>
                    <div class="form-group mb-4">
                        <input type="password" required class="form-control" id="exampleInputPassword1" placeholder="Enter Password" name="password">
                    </div>
                    <div class="form-group">
                        <span>
                    ...
                    <div class="form-group clearfix">
                        <button type="submit" class="btn btn-purple btn-pill btn-block" name="login">LOGIN</button>
                    </div>
                </form>
            </div>
            <!--/login form-->
